...
class OmniSciDBClient(SQLClient):
    ...
    def add_column(self, table_name, column_name, omniscidb_data_type):
        ...
        table_name : string
        column_name : string
        omniscidb_data_type : string

        Examples
        --------
        >>> table_name = 'my_table'
        >>> column_name = 'my_column'
        >>> omniscidb_data_type = 'INT'
        >>> con.add_column(table_name, column_name, omniscidb_data_type)
        """

        statement = ddl.AddColumn(table_name, column_name, omniscidb_data_type)
        self._execute(statement, False)
